...
<div class="container">
    ...
    <div style="float: left">
        <form class="form-inline" action="${pageContext.request.contextPath}/findUserByPageServlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" value="${condition.email[0]}" class="form-control" id="exampleInputEmail4">
            </div>
    ...
    <div style="float: right; margin: 5px">
        ...
        <a class="btn btn-primary" href="javascript:void(0);" id="deSelected">删除选中</a>
    </div>
